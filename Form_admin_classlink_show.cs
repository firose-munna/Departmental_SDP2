...
namespace smart_department
{
    public partial class Form_admin_classlink_show : Form
    {
        ...
        private void GetClassLinkRecord()
        {
            ...
            cmd.CommandText = "SELECT Intake_No, Sec, Course_ID, Classroom_Code, Link FROM class_link where Intake_No = '" + comboBox_intake_select_classlink_basic.Text + "' and Sec = '" + txt_show_classlink_sec.Text + "';";
