...
namespace smart_department
{
    public partial class Form_admin_SlideRecord_show : Form
    {
        ...
        private void GetSlideRecord()
        {
            ...
            cmd.CommandText = "SELECT Intake_No, Sec, Record_Date, Course_ID, Slide_Link, Record_Video FROM slide_and_record where Intake_No = '" + comboBox_intake_select_SlideRecord.Text + "' and Sec = '" + txt_show_SlideRecord_sec.Text + "' and Record_Date = '" + txt_show_SlideRecord_date.Text + "';";
